...
const en: Record<string, string> = {
  ...
  'history.4.storyTitle': 'The Great Renovation of Jirawala Temple',
  'history.4.storySubtitle': "A testament to the community's devotion and a Guru's miraculous intuition.",
  'history.4.p1.title': 'The Call for Renewal',
  'history.4.p1.desc': 'After observing the 100-year-old temple, Acharya Bhagwant inspired the Kuvala Sangh to undertake a complete renovation. When the community worried about funds, the Guru promised that by the time of consecration, they would have a surplus—a divine word that held true.',
  'history.4.p2.title': 'The Night Shifts of Devotion',
  'history.4.p2.desc': 'Inspired by the Acharya to stop idling and start building, the youth and the community joined hands. What laborers built by day, the devoted villagers matched with their tireless labor throughout the night.',
  'history.4.p3.title': "The Guru's Intuition & The Storm",
  'history.4.p3.desc': 'One night around 11:30 PM, the Acharya urgently ordered everyone to evacuate the deep foundation pits. Moments after they stepped out, a violent storm struck, crashing heavy metal sheets into the empty pits, saving countless lives through the Guru’s timely intuition.',
  'history.4.p4.title': 'The Triumphant Completion',
  'history.4.p4.desc': 'The unwavering faith of the community culminated in V.S. 2054. A magnificent three-spired temple, resembling a celestial vehicle, stood tall as the new home for Shri Jirawala Dada and the divine idols.',
...
const gu: Record<string, string> = {
  ...
  'history.4.storyTitle': 'શ્રી જીરાવલા જૈન મંદિરનો ભવ્ય જિર્ણોદ્ધાર',
  'history.4.storySubtitle': 'ભક્તોની અતુટ શ્રદ્ધા અને ગુરુદેવની દિવ્ય સૂઝબૂઝનું જીવંત ઉદાહરણ.',
  'history.4.p1.title': 'જિર્ણોદ્ધારની પ્રેરણા',
  'history.4.p1.desc': 'જિનાલયને ૧૦૦ વર્ષ જેટલો સમય થતાં, આચાર્ય ભગવંતે કુવાળા સંઘને આમૂલચૂલ જિર્ણોદ્ધારની પ્રેરણા કરી. સંઘની આર્થિક ચિંતા દૂર કરતા ગુરુદેવે કહ્યું કે પ્રતિષ્ઠા સમયે તમારી પાસે રકમ વધી પડશે, અને આ વચન સિદ્ધ થયું.',
  'history.4.p2.title': 'ભક્તિનો અનોખો પક્ષ',
  'history.4.p2.desc': 'પૂજ્યશ્રીની પ્રેરણાથી યુવાનોએ ઓટલે બેસી ગપ્પા મારવાનું છોડીને દેરાસરના નિર્માણમાં વેગ લાવ્યો. દિવસે મજૂરો જેટલું કામ કરતા, રાત્રિના સમયે પરમાત્માનો ભક્તવર્ગ તેટલું જ કામ પ્રેમથી કરી લેતો.',
  'history.4.p3.title': 'ગુરુની સમયસૂચકતા અને વાવાઝોડું',
  'history.4.p3.desc': 'એક રાત્રે ૧૧:૩૦ વાગ્યે ગુરુદેવે કહેવડાવ્યું કે તરત જ બધા ખાડામાંથી બહાર આવી જાઓ. બધાના બહાર આવતા જ ભયંકર વાવાઝોડું આવ્યું અને પતરાઓ ખાડામાં પડ્યા, જ્ઞાની ગુરુની સમયસૂચકતાથી સૌનો જીવ બચી ગયો.',
  'history.4.p4.title': 'ભવ્ય પ્રતિષ્ઠા અને પૂર્ણતા',
  'history.4.p4.desc': 'ભક્તોની અતુટ શ્રદ્ધાથી વિ.સં. ૨૦૫૪ માં દેવવિમાન તુલ્ય ત્રિશિખરીય નૂતન જિનાલય તૈયાર થઈ ગયું. આ દિવ્ય મંદિરમાં શ્રી જીરાવલા દાદા અને અન્ય પરમાત્માઓ ભવ્યતાથી ગાદીનસીન થયા.',
